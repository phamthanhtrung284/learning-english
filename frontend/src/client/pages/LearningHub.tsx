  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 45% 70% at 0% 65%, var(--glow-red) 0%, transparent 60%)",
        }}
        aria-hidden
      />

      <div
        className="absolute inset-y-0 z-0 hidden md:block"
        style={{ left: "28%", right: 0 }}
      >
        <img
          src="/hero.png"
          alt=""
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, var(--bg) 0%, color-mix(in srgb, var(--bg) 55%, transparent) 30%, transparent 62%)",
          }}
          aria-hidden
        />
        <div
      ...
      <div className="relative z-10 flex flex-1 items-center">
        <div className="w-full px-8 py-10 md:w-[50%] md:px-12 lg:px-16 xl:px-20">
          <div
            className="inline-flex w-fit items-center gap-2 rounded-full px-3.5 py-1.5 text-[11px] font-bold uppercase tracking-[0.22em]"
            style={{
              border:
          ...
          <h1
            className="mt-5 font-black leading-[1.06] tracking-tight"
            style={{
          ...
          >
            ...
            <span
              style={{
                background:
                  "linear-gradient(90deg, var(--primary-2) 0%, var(--primary) 55%, #8b0000 100%)",
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <button
              ...
              style={{
                ...
                background:
                  "linear-gradient(135deg, var(--primary-2) 0%, var(--primary) 60%, #8b0000 100%)",
                boxShadow:
                  "0 4px 24px rgba(192,57,43,0.4), inset 0 1px 0 rgba(255,255,255,0.12)",
              }}
            >
              Start Reading Now →
            </button>
