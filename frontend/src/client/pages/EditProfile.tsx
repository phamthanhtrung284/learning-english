...
export default function EditProfile({ onProfileUpdated }: EditProfileProps) {
  ...
  return (
    <div className="surface-panel animate-fade-rise relative overflow-hidden p-6 md:p-10">
      <p className="relative text-xs font-bold uppercase tracking-[0.2em] text-[var(--primary)]">
        Profile
      </p>
          ...
          <div className="flex items-center gap-3">
            <div className="relative shrink-0">
              ...
              >
                {avatar ? (
                  <img
                    src={avatar.startsWith('http') ? avatar : `${BACKEND}${avatar}`}
                    alt=""
